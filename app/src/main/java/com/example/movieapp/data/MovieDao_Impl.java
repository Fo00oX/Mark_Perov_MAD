...
/**
 ...
 An implementation of the [MovieDao] interface generated by Room.

  __db The [RoomDatabase] instance.

  __insertionAdapterOfMovie The [EntityInsertionAdapter] for inserting [Movie] instances into the database.

  __customConverters A [CustomConverters] instance for converting custom data types.

  __deletionAdapterOfMovie The [EntityDeletionOrUpdateAdapter] for deleting [Movie] instances from the database.

  __updateAdapterOfMovie The [EntityDeletionOrUpdateAdapter] for updating [Movie] instances in the database.

  __preparedStmtOfDeleteAll The [SharedSQLiteStatement] for deleting all [Movie] instances from the database.
 */
...
public final class MovieDao_Impl implements MovieDao {
    ...
    /**
     ...
     Constructs a new [MovieDao_Impl] instance.

     @param __db The [RoomDatabase] instance.
     */
    ...
    /**
     * @getAllFavorites returns a Flow of a list of movies that have been marked as
     * favorites by the user. It executes an SQL statement to retrieve all movies with the
     * [isFavorite] attribute set to true, then maps the result set into a list of Movie objects.
     *
     */
    @NonNull
    @Override
